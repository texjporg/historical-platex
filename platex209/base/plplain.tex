% File pLPLAN
%    - Copyrighted & Created 24 Dec 1993 from LPLAIN version 2.09J-11/18/89
%    - by ASCII Corporation & Impress Corporation.
%
% Original LPLAIN File
...
% 
% This is the pLaTeX version of the plain TeX format that's described in 
...
% pLaTeX change:
% Add one more magnification size,
% in order to have compatibility with NTT-jTeX.
%
...
\def\strut{\relax\ifmmode\copy\strutbox\else\copy\strutbox\fi}
...
% pLaTeX change:
% change the \_ macro for supporting Tate dir.
%
%\def\_{\leavevmode \kern.06em \vbox{\hrule width.3em}}
\def\_{\leavevmode\kern.06em
  \iftdir\raise-\tbaselineshift\vbox{\hrule width.3em}\else\vbox{\hrule width.3em}\fi}
%
...
%
% pLaTeX change:
% change font definition file name.
%\input lfonts
\input plfonts
...
% pLaTeX change:
% load additional macro file for Tate dir.
%
\input platex
...
% pLaTeX: File called pLPLAIN
% Identify the current format

\def\fmtname{plplain}
\def\fmtversion{p2.09J-12/24/93} % identifies the current format
\typeout{Input any local modifications here.}

% pLaTeX change: 
% parameter set for nihongo.
